...
class Tag < ApplicationRecord
  ...
  TYPES = ['Rating', 'ArchiveWarning', 'Category', 'Era', 'Media', 'Fandom', 'Relationship', 'Character', 'Freeform', 'Banned' ]
  ...
  %w(Fandom Media Character Era Relationship Freeform).each do |tag_type|
